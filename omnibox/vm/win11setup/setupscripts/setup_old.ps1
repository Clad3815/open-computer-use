...
# Section - Language and Regional Settings
Write-Host "Configuring French keyboard layout and timezone..."
...
Write-Host "Language and timezone configuration completed."
